...
class Assignment(models.Model):
    ...
    assignment_number = models.PositiveSmallIntegerField(null=True, blank=True, editable=False)
...
class EnrolledStudenAssignmentFTQuestion(models.Model):
    ...
    answered_file = models.FileField(upload_to='assignment/students/answers/', null=True, blank=True)
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=[
