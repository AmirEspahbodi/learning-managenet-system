...
class GroupCourseAdmin(admin.ModelAdmin):
    ...
    add_fieldsets = (
        (None, {'fields': ('course_title', 'group_course_number', 'semester', 'teacher', 'tuition', 'percentage_required_for_tuition')}),
    )
    
    list_display = ('course_title', 'group_course_number', 'semester', 'teacher')
