...
urlpatterns = [
    ...
    path('course/<int:course_id>/', StudentCourseDetailAPIView.as_view(), name="course_detail"),
    path('session/<int:session_id>/', StudentSessionDetailAPIView.as_view(), name="session_detail"),
]